...
interface BloodGlucoseReading {
  ...
  time: string;
  glucose_mgdl: number;
  reading_type: 'pre_meal' | 'post_meal' | 'fasting' | 'bedtime';
      ...
      <View style={styles.inputRow}>
        <View style={styles.inputGroup}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setCurrentReading(prev => ({ ...prev, glucose_mgdl: text ? parseInt(text) : undefined }))}
            placeholder="95"
        ...
        <View style={styles.inputRow}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setCurrentReading(prev => ({ ...prev, minutes_post_meal: text ? parseInt(text) : undefined }))}
              placeholder="90"
              keyboardType="numeric"
            />
          </View>
      ...
      <View style={styles.inputRow}>
        <View style={styles.inputGroup}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setCurrentReading(prev => ({ ...prev, energy_level: text ? parseInt(text) : undefined }))}
            placeholder="8"
            keyboardType="numeric"
          />
        </View>
        <View style={styles.inputGroup}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setCurrentReading(prev => ({ ...prev, mood: text ? parseInt(text) : undefined }))}
            placeholder="8"
            keyboardType="numeric"
          />
        </View>
