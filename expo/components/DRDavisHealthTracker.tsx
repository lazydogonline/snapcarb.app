...
export default function DRDavisHealthTracker() {
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<'overview' | 'metrics' | 'meals' | 'supplements' | 'goals'>('overview');
      ...
      <View style={styles.programStatusCard}>
        <LinearGradient colors={['#10B981', '#059669']} style={styles.programStatus}>
          ...
          <Text style={styles.programStatusSubtitle}>
            {drDavisProgress 
              ? `Day ${drDavisProgress.current_day} - ${drDavisProgress.current_phase.replace('-', ' ')}`
  ...
  const renderGoals = () => (
    <View style={styles.tabContent}>
      <View style={styles.section}>
        ...
        <Text style={styles.sectionSubtitle}>
          Set and track your DR Davis program goals
        </Text>
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <LinearGradient colors={[colors.primary, colors.secondary]} style={styles.header}>
        <Text style={styles.headerTitle}>DR Davis Health Tracker</Text>
        <Text style={styles.headerSubtitle}>Track your Infinite Health journey</Text>
      </LinearGradient>
      ...
      <View style={styles.tabNavigation}>
        {[
          ...
          { key: 'metrics', label: 'Metrics', icon: Scale },
